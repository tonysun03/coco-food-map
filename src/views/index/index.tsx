...
const seed: FoodRecord[] = [
  ...
  ),
  {
    ...
    shop: "三出山",
    address: "北京 · 荟聚",
    coordinates: { lat: 39.7949, lng: 116.3282 },
    map: { x: 57, y: 57 },
    visited: false,
    visits: [],
    attributes: {
    ...
    rating: { overall: 0, taste: 0, value: 0, environment: 0 },
    review: "想去吃；具体菜品和评价待补充。",
    emoji: "🍽️",
    color: "#d9a15f",
  },
  {
